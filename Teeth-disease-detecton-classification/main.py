...
# Load the model
model = load_model('teeth_disease_trained_model.h5')

# Define class names
class_names = ['Calculus', 'Gingivitis', 'Mouth Ulcer', 'Tooth Discoloration', 'caries', 'hypodontia']

st.title("Teeth Disease Detection Using Convolution Neural Network(CNN)")
